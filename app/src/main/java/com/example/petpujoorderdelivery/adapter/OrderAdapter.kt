...
import com.example.petpujoorderdelivery.model.OrderItems
...
class OrderAdapter(val chefItems:ArrayList<ChefOrders>, val context: Context, val docRef:CollectionReference):RecyclerView.Adapter<OrderAdapter.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val view = layoutInflater.inflate(R.layout.order_deliver,parent,false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.ordView.text = "OID "+chefItems.get(position).transactionId.toString()
        holder.timeView.text = chefItems.get(position).time.toString()
        holder.rollView.text = "Roll - "+chefItems[position].roll
    ...
    class MyViewHolder(view:View): RecyclerView.ViewHolder(view){
        ...
        init {
            ...
            rollView = view.findViewById(R.id.ordRoll)
        }
    }
}